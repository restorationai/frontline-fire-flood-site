...
export const brand = {
  ...
  trackingPhone: "(253) 342-4491",
  trackingPhoneRaw: "+12533424491",
  ...
  jobPhotos: [] as string[],
  sameAsUrls: ["https://www.facebook.com/FrontlineFireFlood/", "https://www.instagram.com/frontline_fire_and_flood/", "https://frontlinefireflood.com/meet-the-team/"] as string[],
  ...
  gbpReviews: [
    ...
    { author: "Becky", rating: 5, text: "We had a great experience with this company. From the beginning of our sewer problem then cleanup then the remodel. I would recommend them. Very happy with the results.", when: "September 2026" },
